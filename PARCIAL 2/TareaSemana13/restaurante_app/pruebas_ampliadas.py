...
def prueba_busqueda_productos() -> None:
    ...
    print(f"[OK] {restaurante.obtener_cantidad_productos()} productos registrados")

    # Buscar producto existente
    exito, producto, msg = restaurante.buscar_producto("P001")
    print(f"[OK] Búsqueda exitosa: {msg}")
    ...
    print(f"[OK] Búsqueda fallida (esperada): {msg}")
...
def prueba_busqueda_clientes() -> None:
    ...
    print(f"[OK] {restaurante.obtener_cantidad_clientes()} clientes registrados")
...
def prueba_eliminacion_productos() -> None:
    ...
    print(f"[OK] Eliminación exitosa: {msg}")
    ...
    print(f"[OK] Eliminación fallida (esperada): {msg}")
